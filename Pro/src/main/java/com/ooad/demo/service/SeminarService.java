...
public class SeminarService {
    ...
    /*public SeminarPreVO getSeminarPreVOBySeminarIdAndCClassId(int seminarId, int cClassId) {
        Seminar seminar = seminarDao.getById(seminarId, true, false, false, false);
        List<Presentation> presentations = presentationDao.listBySeminarIdAndCClassId(seminarId, cClassId);
        SeminarPreVO seminarPreVO = new SeminarPreVO(presentations);
        //设置讨论课主题
    ...
    public PreFileDownloadVO getPreFileDownLoadVOBySeminarId(int seminarId) {
        ...
        //只拿course名字
        preFileDownloadVO.setCourseName(courseDao.getById(seminar.getCourseId(), false, false, false, false, false).getName());
    ...
    public SeminarSubInfoVO getSeminarSubInfoVOBySeminarId(int seminarId) {
        return new SeminarSubInfoVO(seminarDao.getById(seminarId, false, false, false, false));
    }
    ...
    public SeminarInfoVO getSeminarInfoVOBySeminarId(int seminarId) {
        Seminar seminar = seminarDao.getById(seminarId, false, false, false, false);
    ...
    public ReportFileDownloadVO getReportFileDownliadVOBySeminarId(int seminarId) {
        ...
        //只拿course名字
        reportFileDownloadVO.setCourseName(courseDao.getById(seminar.getCourseId(), false, false, false,false,false).getName());
